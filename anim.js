...
var lyricsData = [
  ...
  { text: "Only fools rush in", time: 13 },
  { text: "But I can't help", time: 22 },
  { text: "falling in love with you", time: 26 },
  { text: "Shall I stay?", time: 35 },
  { text: "Would it be a sin", time: 42 },
  { text: "If I can't help", time: 50 },
  ...
  { text: "Some things are meant to be", time: 75 },
  { text: "Take my hand", time: 82 },
  { text: "Take my whole life, too", time: 88 },
  { text: "For I can't help", time: 96 },
  { text: "falling in love with you", time: 102 },
  { text: "Like a river flows", time: 110 },
  { text: "Surely to the sea", time: 114 },
  { text: "Darling, so it goes", time: 118 },
  { text: "Some things are meant to be", time: 122 },
  { text: "Take my hand", time: 128 },
  { text: "Take my whole life, too", time: 134 },
  { text: "For I can't help", time: 142 },
  { text: "falling in love with you", time: 147 },
  { text: "For I can't help", time: 157 },
  { text: "falling in love with you", time: 162 },
];
